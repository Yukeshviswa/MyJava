...
public class City77 {
	...
	City77(String userName, String Password) {

		this.setUserName(userName);
		this.setPassword(Password);
	}

	public static boolean login(City77 user) {
	...
	public static void edit(City77 user) {
	...
	public static void country(City77 user) {
	...
	public static void project(City77 user) {
		System.out.println(""
				+ "\n 1.Construction "
				+ "\n 2.Farming "
				+ "\n 3.Road "
	...
	private static void Hospital_Requirments(City77 user) {
	
		
	}

	public static void details(City77 user) {
	...
	public static void uniq(City77 user) {
	...
	public static void print(City77 user) {
	...
	public static void Construction(City77 user) {
	...
	public static void Farming(City77 user) {
	...
	public static void Road_Facilities(City77 user) {
	String street = "";
	...
	public static void Water_Facilities(City77 user) {
	...
	public static void Childrens_Park(City77 user) {
	...
	public static void Hospital_Requirments1(City77 user) {
		 class Doctor  {
			    private String name;
			...
			class HospitalRequirments{
			    public static void requirement() {
			        ...
			        doctors.add(new Doctor("Dr. Akash", "Fever"));   
	...
	public static void main(String args[]) {
		City77 user = new City77("Uniq", "1234");
		City77.uniq(user);
	}

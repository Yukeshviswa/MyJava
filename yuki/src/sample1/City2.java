...
public class City2 {
	...
	City2(String userName, String Password) {

		this.setUserName(userName);
		this.setPassword(Password);
	}

	public static boolean login(City2 user) {
	...
	public static void edit(City2 user) {
	...
	public static void country(City2 user) {
	...
	public static void project(City2 user) {
		System.out.println(""
				+ "\n 1.Construction "
				+ "\n 2.Farming "
				+ "\n 3.Road "
	...
	private static void Hospital_Requirments(City2 user) {
		// TODO Auto-generated method stub
		
	}

	public static void details(City2 user) {
	...
	public static void uniq(City2 user) {
	...
	public static void print(City2 user) {
	...
	public static void Construction(City2 user) {
	...
	public static void Farming(City2 user) {
	...
	public static void Road_Facilities(City2 user) {
	String street = "";
	...
	public static void Water_Facilities(City2 user) {
	...
	public static void Childrens_Park(City2 user) {
	...
	public static void Hospital_Requireents(City2 user) {
		 class Doctor  {
			    private String name;
